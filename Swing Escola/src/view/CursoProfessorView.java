 ...
 */
public class CursoProfessorView extends javax.swing.JFrame {

    /**
     * Creates new form CursoProfessorView
     */
    public CursoProfessorView() {
        initComponents();
        
        this.setLocationRelativeTo(null);
        tbProfessorCurso.setModel(new CursoTableModel(new cursoDao().listarTodos()));
    }
    ...
    private void initComponents() {
        ...
        tbProfessorCurso = new javax.swing.JTable();
        ...
        jLabel1.setText("Pesquisar curso por professor");

        txtProfessor.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtProfessorKeyPressed(evt);
            }
        });

        tbProfessorCurso.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tbProfessorCurso);
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(txtProfessor, javax.swing.GroupLayout.PREFERRED_SIZE, 439, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(117, 117, 117))))
        );
    ...
    private void txtProfessorKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtProfessorKeyPressed
        String pesquisa = txtProfessor.getText();
        tbProfessorCurso.setModel(new CursoTableModel(new professorDao().CursoPorProfessor(pesquisa)));
    }//GEN-LAST:event_txtProfessorKeyPressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CursoProfessorView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tbProfessorCurso;
